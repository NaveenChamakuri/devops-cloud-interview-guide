as a devops engineer cost optimization is a part of my day to day activity
  - identify the unused ebs voluems and delete those voluems- some of completely unused, some of unused from last 1 year some of have the snapshots
  -first i used 'aws cli to identify the ec2 'describe-volueme' after that i realized and start to use lamda functions
